...
import com.padcmyanmar.poc_screen_implementation.POCScreenImplementationApp;
...
public class MoviesContract {
    ...
    public static final String CONTENT_AUTHORITY = POCScreenImplementationApp.class.getPackage().getName();
    //com.padcmyanmar.poc_screen_implementation

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);
    //content://com.padcmyanmar.poc_screen_implementation

    public static final String PATH_POPULARMOVIES = "popular_movies";
    public static final String PATH_GENREIDS = "genre_ids";
    public static final String PATH_POPULARMOVIESGENREIDS = "popular_movies_genre_ids";

    public static final class PopularMovieEntry implements BaseColumns {

        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_POPULARMOVIES).build();
        ...
        public static final String COLUMN_ORIGNINAL_TITLE = "original_title";
    ...
    public static final class GenreIdEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_GENREIDS).build();

        public static final String DIR_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_GENREIDS;

        public static final String ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_GENREIDS;
    ...
    public static final class PopularMovieGenreIdEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_POPULARMOVIESGENREIDS).build();

        public static final String DIR_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_POPULARMOVIESGENREIDS;

        public static final String ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_POPULARMOVIESGENREIDS;

        public static final String TABLE_NAME = "poplar_movies_genre_ids";
